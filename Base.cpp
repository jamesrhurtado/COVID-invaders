...
//move between columns and animates the sprite so as to it seems it is walking
void Base::animate() {
	this->idx++;
...
int Base::getElementType() {
	return this->elementType;
}

void Base::setIsCaptured(bool v){
	this->captured = v;
}

bool Base::getIsCaptured() {
